...
highlight StatusLineNC guifg=SlateBlue guibg=White 
...
function AddTitle()
    call append(0,"/*======================================================================")
    call append(1," *           Author :   kevin")
    call append(2," *         Filename :   ".expand("%d:t"))
    call append(3," *       Creat time :   ".strftime("%Y-%m-%d %H:%M"))
    call append(4," *      Description :")
    call append(5,"========================================================================*/")
    call append( 6,"#include <iostream>")
    call append( 7,"#include <algorithm>")
    call append( 8,"#include <cstdio>")
    call append( 9,"#include <cstring>")
    call append(10,"#include <queue>")
    call append(11,"#include <cmath>")
    call append(12,"#define M ")
    call append(13,"using namespace std;")
    call append(14,"int main(int argc,char *argv[])")
    call append(15,"{")
...
let g:neocomplcache_enable_at_startup = 1 "自动补全插件自动启动
"powerline{ 
